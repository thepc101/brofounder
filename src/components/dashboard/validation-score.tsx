  ...
  return (
    <Card className="border-white/[0.06] bg-gradient-to-br from-white/[0.03] to-transparent">
      <CardHeader className="pb-2 pt-4 px-4">
        <CardTitle className="text-[13px] font-medium text-white/55">Validation Score</CardTitle>
      </CardHeader>
      <CardContent className="flex flex-col items-center px-4 pb-4">
        <div className="relative flex items-center justify-center">
          <svg width="90" height="90" className="-rotate-90">
            <circle cx="45" cy="45" r="36" fill="none" stroke="rgba(255,255,255,0.04)" strokeWidth="5" />
            <circle
              cx="45" cy="45" r="36" fill="none"
              stroke="rgba(99, 140, 255, 0.4)"
              strokeWidth="5"
          ...
          <span
            className="absolute text-xl font-normal text-white/65"
